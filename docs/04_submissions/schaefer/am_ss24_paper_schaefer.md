...
* I think this is a interesting research project!
* To me, the main question is the scope of the project as it feels very big to me. E.g., what do you mean with "in the field of audiovisual instruments" specifically? Do these instruments already exist? If yes, with which criteria do you select them? If not, how and when are you implementing them (which would probably take much more time than ECTS points allocated to the paper)? I am not sure with the information given above whether you want to focus on the experience of the audience or the artist? Also, claiming an "intersubjectiv coherent" feels overly complicated, maybe even a bit pompous, to me for starting the project (I am also not entirely sure what you mean with "intersubjectiv" - maybe you can explain this to me and maybe I missing knowledge on the term). Where are the  parameter mapping coming from? Again, something you need to research and develop? Lastly, do you really want to claim that at some point you have proven to have achieved intersubjectively coherent parameter mappings? That puts on a lot of pressure and I do not recommend to go down the road of proving validity. That you can then do in your PhD.
* Don't get me wrong, I don't want to spoil your enthusiasm for research and your grand plans. However, I advise you to go step by step, starting small. My feedback also depends a bit on how much you are planning to implement the objects of investigation yourself (mappings and instruments) and how much you are actually referring to existing developments - this is not yet clear to me. We could also discuss to add ECTS for the practical developments for the project - if you are interested in that you have to talk to me ASAP about it.
* For this short paper you could, e.g. (this is pretty much taking your question and breaking it in its three components, focusing on one for now), 
    * Focus on the parameters and possible mappings in the sense of "which audio and which visual parameters are feasible for which mappings and why?". 
    * Or you want to focus on the effect that you want to achieve, in the direction of a multimodal audience experience (above you were referring to the audience and not the artist, correct?). Theoretically investigate how to describe and validate such an experience? You could add a first case study for that.
    * Or focus on the aspect of audiovisual instruments - how to define an instrument, what kind of instruments do you envision, what is needed for enabling creative-artistic expression and how could these needs be theoretically met with the type of instrument you envision.
* Alternatively, you could also focus on one specific case of mapping and instrument, in the sens of "implemented instrument X". But then this would need to be clear in the question / description. E.g. in the direction of "An exemplary audiovisual parameter mapping for instruments X" Then the question remains open regarding what specifically you would want to analyze that case?
* All in all, please break your question and topic further down. While it is truly great to have a grander vision and a lot of context it can also easily become hindering for you or too vague to produce helpful insights.
* I am also happy to discuss your topic further in person. If you are interested in that please make an appointment with me.
